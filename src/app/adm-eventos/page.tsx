          ...
          return (
            <div key={key}>
              ...
              <div className={classNames(
                ...
                <div className="bg-[#100D1E] rounded-[10px] flex items-center justify-between px-3 py-2 cursor-pointer"
                     onClick={() => toggleAcordeon(key)}>
                  <label className={classNames(
                    "flex items-center gap-2 text-white",
                    all ? "bg-clip-text text-transparent bg-gradient-to-r from-[#43A3D5] to-[#9C60DA]" : ""
                  )}
                ...
                {aberto && (
                  <div className="flex flex-wrap gap-2 mt-3 justify-center px-2 pb-2">
                    {imgs.length === 0 && (
                      <p className="text-white/50 italic">Sem imagens neste evento</p>
                    )}
                    {imgs.map(img => (
                      <div
                        key={img.id}
