...
export default function SuccessDeleteModal({ open, onClose }: SuccessModalProps) {
  // fecha no ESC
  useEffect(() => {
      ...
      <div className="w-80 bg-[#100D1E] rounded-2xl overflow-hidden">
        ...
        <div className="px-6 py-8 flex flex-col items-center">
          ...
          <button
            onClick={onClose}
            className="
              mt-6 w-[172px] h-[40px] py-2 text-white text-sm rounded-full border border-white
